...
his was challenging start with react. Working with the movie databse api. Sreach must not refresh whole page only movie container. Search must be dedicated component(NO inside mani app js) and
pass searched value to main app as a prop
...
The page will reload wghen you make changes.\
